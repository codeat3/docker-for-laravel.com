<section class="relative py-2 bg-yellow-200" data-primary="yellow-500" data-tails-scripts="//unpkg.com/alpinejs">
    <div class="flex items-center justify-between h-20 px-8 mx-auto max-w-7xl">
        <a href="#_"
            class="relative z-10 flex items-center w-auto text-2xl font-black leading-none text-gray-900 select-none">docker-for-laravel.com</a>
        <nav class="items-center justify-center hidden space-x-5 text-gray-200 md:flex lg:space-x-8">
            <a href="#_" x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false"
                ...
                <span class="absolute bottom-0 left-0 inline-block w-full h-2 -mb-2 overflow-hidden">
                    <span x-show="!hover"
                        ...
                        data-primary="yellow-500" x-transition:enter="transition ease-out duration-300"
            ...
            <a href="#_" class="relative h-6 group">
                <span
                    ...
                    data-rounded="rounded-lg" data-primary="yellow-600">Signup</span>
